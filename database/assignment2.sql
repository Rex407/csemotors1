...
-- Data for table `inventory` (your data)
...
-- =============================================
-- REQUIRED ASSIGNMENT 2 TASKS
-- =============================================

-- TASK 1: Insert Tony Stark as Admin
...
-- TASK 2: Update Tony Stark to Client
...
-- TASK 4: Update description (small interiors → huge interior)
...
-- TASK 5: JOIN Query (inventory + classification)
SELECT 
    i.inv_make,
    i.inv_model,
...
SELECT 'Classification Data (5 entries expected):' as message;
SELECT COUNT(*) as count FROM public.classification;

-- 2. Check inventory
SELECT 'Inventory Data (15 vehicles expected):' as message;
SELECT COUNT(*) as count FROM public.inventory;

-- 3. Check description update
SELECT 'Description Update Check (Hummer should be updated):' as message;
SELECT 
    inv_make,
    inv_model,
    CASE 
...
-- 4. Check JOIN query works
SELECT 'JOIN Query Results (Sport cars):' as message;
SELECT 
    i.inv_make,
    i.inv_model,
    c.classification_name
...
-- 5. Check image paths
SELECT 'Image Path Check (should start with /images/vehicles/):' as message;
SELECT 
    inv_make,
    inv_model,
    LEFT(inv_image, 18) as image_path_sample
FROM public.inventory 
LIMIT 3;

-- 6. Final summary
SELECT '=== ASSIGNMENT 2 COMPLETED SUCCESSFULLY ===' as message;
SELECT 'All required tasks have been executed.' as confirmation;